...
$[a < m] \cdot \sigma$. That kind of typing still means that the
parameter will be used m times, but every time the argument is used
...
in $ dlPCF_{V} $  indicate the number of times the function is copied in a term. Thus
